...
class DB(object):
    def __init__(self):
        ...
        "1": schema.File(1, "demoA_sample1_raw_reads.fastq","case1","sample1", "controlled", 
                        self.FILE_SIZES["raw"], "Raw Reads", "Fastq", "Illumina MiSeq", "WMGX", schema.FileCases(hits=["1"])),
        "2": schema.File(2, "demoA_sample1_taxonomic_profile.tsv","case1","sample1", "open", 
                        self.FILE_SIZES["taxa"], "Taxonomic Profile", "TSV", "Illumina MiSeq", "WMGX", schema.FileCases(hits=["1"])),
        "3": schema.File(3, "demoA_sample1_gene_families.tsv","case1","sample1", "open", 
                        self.FILE_SIZES["gene"], "Gene Families", "TSV", "Illumina MiSeq", "WMGX", schema.FileCases(hits=["1"])),
        "4": schema.File(4, "demoA_sample2_raw_reads.fastq","case2","sample2", "controlled", 
                        self.FILE_SIZES["raw"], "Raw Reads", "Fastq", "Illumina MiSeq", "WMGX", schema.FileCases(hits=["2"])),
        "5": schema.File(5, "demoA_sample2_taxonomic_profile.tsv","case2","sample2", "open", 
                        self.FILE_SIZES["taxa"], "Taxonomic Profile", "TSV", "Illumina MiSeq", "WMGX", schema.FileCases(hits=["2"])),
        "6": schema.File(6, "demoA_sample2_gene_families.tsv","case2","sample2", "open", 
                        self.FILE_SIZES["gene"], "Gene Families", "TSV", "Illumina MiSeq", "WMGX", schema.FileCases(hits=["2"])),
        "7": schema.File(7, "demoB_sample3_raw_reads.fastq","case3","sample3", "controlled", 
                        self.FILE_SIZES["raw"], "Raw Reads", "Fastq", "Illumina HiSeq", "16S", schema.FileCases(hits=["3"])),
        "8": schema.File(8, "demoB_sample3_taxonomic_profile.tsv","case3","sample3", "open", 
                        self.FILE_SIZES["taxa"], "Taxonomic Profile", "TSV", "Illumina HiSeq","16S", schema.FileCases(hits=["3"])),
        "9": schema.File(9, "demoB_sample3_gene_families.tsv","case3","sample3", "open",
                        self.FILE_SIZES["gene"], "Gene Families", "TSV", "Illumina HiSeq", "16S", schema.FileCases(hits=["3"])),
        "10": schema.File(10, "demoB_sample4_raw_reads.fastq","case4","sample4", "controlled", 
                        self.FILE_SIZES["raw"], "Raw Reads", "Fastq", "Illumina HiSeq", "16S", schema.FileCases(hits=["4"])),
        "11": schema.File(11, "demoB_sample4_taxonomic_profile.tsv","case4","sample4", "open", 
                        self.FILE_SIZES["taxa"], "Taxonomic Profile", "TSV", "Illumina HiSeq", "16S", schema.FileCases(hits=["4"])),
        "12": schema.File(12, "demoB_sample4_gene_families.tsv","case4","sample4", "open", 
                        self.FILE_SIZES["gene"], "Gene Families", "TSV", "Illumina HiSeq", "16S", schema.FileCases(hits=["4"])),
        }
