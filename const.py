            ...
            "edges": [
              ...
              },
              {
                "node": {
                      ...
                      "edges": [
                        {
                          "node": {
                            ...
                            "id": "Q2FzZUFubm90YXRpb246OTQyYzAwODgtYzlhMC00MjhjLWE4NzktZTE2ZjhjNWJmZGI4OjZkNTcyMTFhLTQwMmItNTJjOS1iODU3LTY2NTE2NGM2MzMzOQ=="
                          }
                        }
                      ],
                      "total": 4
                  ...
                  "primary_site": "Kidney",
                  "project": {
                    "id": "UHJvamVjdDo5NDJjMDA4OC1jOWEwLTQyOGMtYTg3OS1lMTZmOGM1YmZkYjgjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-KIRC"
                  },
                  "submitter_id": "TCGA-CJ-4642",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Transcriptome Profiling",
              ...
              },
              {
                "node": {
                  "annotations": {
                    "hits": {
                      "edges": [
                        {
                          "node": {
                            "annotation_id": "6366c10f-603a-53f3-a367-89d9aa56528e",
                            "id": "Q2FzZUFubm90YXRpb246NGJmYmNlMmItOWQwYi00ZThhLTk1MGYtZmQ4ZTBiYTNlMDVhOjYzNjZjMTBmLTYwM2EtNTNmMy1hMzY3LTg5ZDlhYTU2NTI4ZQ=="
                          }
                        }
                      ],
                      "total": 3
                  ...
                  "case_id": "4bfbce2b-9d0b-4e8a-950f-fd8e0ba3e05a",
                  "demographic": {
                    "ethnicity": "not hispanic or latino",
                    "gender": "female",
                    "race": "white"
                  ...
                  "project": {
                    "id": "UHJvamVjdDo0YmZiY2UyYi05ZDBiLTRlOGEtOTUwZi1mZDhlMGJhM2UwNWEjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-HNSC"
                  },
                  "submitter_id": "TCGA-BA-4077",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Transcriptome Profiling",
              ...
              },
              {
                "node": {
                  "annotations": {
                    "hits": {
                      "edges": [
                        {
                          "node": {
                            "annotation_id": "1baab405-44bd-57b9-aa63-9af2e953f4b8",
                            "id": "Q2FzZUFubm90YXRpb246NTFjMzc0NDktNmEyZS00YzNkLWE3Y2MtMDZmOTAxZTEyMjRmOjFiYWFiNDA1LTQ0YmQtNTdiOS1hYTYzLTlhZjJlOTUzZjRiOA=="
                          }
                        }
                      ],
                      "total": 3
                  ...
                  "primary_site": "Rectum",
                  "project": {
                    "id": "UHJvamVjdDo1MWMzNzQ0OS02YTJlLTRjM2QtYTdjYy0wNmY5MDFlMTIyNGYjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-READ"
                  },
                  "submitter_id": "TCGA-AG-A014",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Transcriptome Profiling",
              ...
              },
              {
                "node": {
                  "annotations": {
                    "hits": {
                      "edges": [
                        {
                          "node": {
                            "annotation_id": "f1fd3cb6-094e-5502-80a0-47b5cc3a0ac3",
                            "id": "Q2FzZUFubm90YXRpb246YTc5NWE4NDEtOWZkNi00ZWFjLWI4NzEtYThjNzAyNDg3MDBmOmYxZmQzY2I2LTA5NGUtNTUwMi04MGEwLTQ3YjVjYzNhMGFjMw=="
                          }
                        }
                      ],
                      "total": 3
                  ...
                  "case_id": "a795a841-9fd6-4eac-b871-a8c70248700f",
                  "demographic": {
                    "ethnicity": "not hispanic or latino",
                    "gender": "male",
                    "race": "white"
                  ...
                  "primary_site": "Brain",
                  "project": {
                    "id": "UHJvamVjdDphNzk1YTg0MS05ZmQ2LTRlYWMtYjg3MS1hOGM3MDI0ODcwMGYjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-GBM"
                  },
                  "submitter_id": "TCGA-06-0209",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Copy Number Variation",
              ...
              },
              {
                "node": {
                  "annotations": {
                    "hits": {
                      "edges": [
                        {
                          "node": {
                            "annotation_id": "76a832a7-f663-5297-a16b-4f2b8234c72e",
                            "id": "Q2FzZUFubm90YXRpb246Mzk4Njc3NTYtMGVmMC00NDA4LWEwZTEtYzg1YWU3YWRiOGVlOjc2YTgzMmE3LWY2NjMtNTI5Ny1hMTZiLTRmMmI4MjM0YzcyZQ=="
                          }
                        }
                      ],
                      "total": 3
                  ...
                  "case_id": "39867756-0ef0-4408-a0e1-c85ae7adb8ee",
                  "demographic": {
                    "ethnicity": "not hispanic or latino",
                    "gender": "male",
                    "race": "white"
                  ...
                  "primary_site": "Kidney",
                  "project": {
                    "id": "UHJvamVjdDozOTg2Nzc1Ni0wZWYwLTQ0MDgtYTBlMS1jODVhZTdhZGI4ZWUjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-KIRC"
                  },
                  "submitter_id": "TCGA-BP-4331",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Transcriptome Profiling",
              ...
              },
              {
                "node": {
                  "annotations": {
                    "hits": {
                      "edges": [
                        {
                          "node": {
                            "annotation_id": "6ef5c71f-ea3c-55dc-8550-37d1b67606d7",
                            "id": "Q2FzZUFubm90YXRpb246ZjM1NWNkNTktZWFhOS00NmM3LWFiMDctYjkwYTdhZmM4NzVjOjZlZjVjNzFmLWVhM2MtNTVkYy04NTUwLTM3ZDFiNjc2MDZkNw=="
                          }
                        }
                      ],
                      "total": 3
                  ...
                  "case_id": "f355cd59-eaa9-46c7-ab07-b90a7afc875c",
                  "demographic": {
                    "ethnicity": "not hispanic or latino",
                    "gender": "female",
                    "race": "white"
                  ...
                  "project": {
                    "id": "UHJvamVjdDpmMzU1Y2Q1OS1lYWE5LTQ2YzctYWIwNy1iOTBhN2FmYzg3NWMjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-LUSC"
                  },
                  "submitter_id": "TCGA-60-2712",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Transcriptome Profiling",
              ...
              },
              {
                "node": {
                  "annotations": {
                    "hits": {
                      "edges": [
                        {
                          "node": {
                            "annotation_id": "9b1c3d57-f929-58d2-8764-626e5209897a",
                            "id": "Q2FzZUFubm90YXRpb246MjVmNjRiODAtMDY3Mi00OTgwLTk4NzUtOTU2YjE2OTkzMDliOjliMWMzZDU3LWY5MjktNThkMi04NzY0LTYyNmU1MjA5ODk3YQ=="
                          }
                        }
                      ],
                      "total": 3
                  ...
                  "case_id": "25f64b80-0672-4980-9875-956b1699309b",
                  "demographic": {
                    "ethnicity": "not hispanic or latino",
                    "gender": "male",
                    "race": "white"
                  ...
                  "primary_site": "Bronchus and lung",
                  "project": {
                    "id": "UHJvamVjdDoyNWY2NGI4MC0wNjcyLTQ5ODAtOTg3NS05NTZiMTY5OTMwOWIjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-LUSC"
                  },
                  "submitter_id": "TCGA-22-1017",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Transcriptome Profiling",
              ...
              },
              {
                "node": {
                  "annotations": {
                    "hits": {
                      "edges": [
                        {
                          "node": {
                            "annotation_id": "0285f114-7681-5afe-9bcd-b379bba3549a",
                            "id": "Q2FzZUFubm90YXRpb246YzY0NTQzNzEtMWY4NC00ZThlLThjM2EtMmVhYzgzODA4MTllOjAyODVmMTE0LTc2ODEtNWFmZS05YmNkLWIzNzliYmEzNTQ5YQ=="
                          }
                        }
                      ],
                      "total": 3
                  ...
                  "case_id": "c6454371-1f84-4e8e-8c3a-2eac8380819e",
                  "demographic": {
                    "ethnicity": "not hispanic or latino",
                    "gender": "male",
                    "race": "white"
                  ...
                  "primary_site": "Kidney",
                  "project": {
                    "id": "UHJvamVjdDpjNjQ1NDM3MS0xZjg0LTRlOGUtOGMzYS0yZWFjODM4MDgxOWUjN2NhNDQ1NzY3MTRlNWRmNWZjYjY1N2QxYWRjODM4ZDIjOl8=",
                    "program": {
                      "name": "TCGA"
                    },
                    "project_id": "TCGA-KIRC"
                  },
                  "submitter_id": "TCGA-DV-5573",
                  "summary": {
                    "data_categories": [
                      {
                        "data_category": "Transcriptome Profiling",
